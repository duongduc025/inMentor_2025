      ...
      <div className="bg-[#007BFF] text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 relative">
          ...
          <form
            ...
            className="flex flex-col md:flex-row gap-3 max-w-4xl mx-auto bg-white/10 backdrop-blur-sm p-4 rounded-xl"
          >
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-6">
            ...
            {["Frontend Developer", "Marketing", "Kế toán", "Sales"].map(
              (term) => (
                <Button
                  key={term}
                  variant="link"
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center">
            <h2 className="text-[#007BFF] text-2xl font-bold mr-2">
              Việc làm nổi bật
            </h2>
        ...
        {loading && !error ? (
          ...
          <div className="text-center py-16 bg-white rounded-xl border">
            ...
            <h3 className="text-xl font-medium text-[#343A40] mb-2">
              Không tìm thấy việc làm
            </h3>
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              Vui lòng thử lại với các từ khóa hoặc bộ lọc khác để tìm kiếm việc
              làm phù hợp với bạn.
            </p>
            <Button
              variant="outline"
                          ...
                          <div className="flex flex-wrap gap-1.5 mb-2">
                            ...
                            {job.isPro && (
                              <span className="inline-flex items-center rounded-full bg-yellow-50 px-2.5 py-0.5 text-xs font-medium text-yellow-700 border border-yellow-200 shadow-sm">
                                ...
                                >
                                  <path
                                    d="M12 15L8.5 18L9.5 14L6.5 11.5L10.5 11L12 7.5L13.5 11L17.5 11.5L14.5 14L15.5 18L12 15Z"
                                    fill="currentColor"
                                  />
                                </svg>
                                Pro
