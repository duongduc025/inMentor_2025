      ...
      <div className="max-w-7xl mx-auto px-4 py-6 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2">
          ...
          <div className="bg-white rounded border p-6 mb-6">
            <h1 className="text-xl font-bold text-[#343A40] mb-6">
              {job.job_title}
            </h1>
          ...
          <div className="bg-white rounded border p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Button
                variant="outline"
                size="sm"
                className="text-[#007BFF] border-[#007BFF]/20 bg-[#007BFF]/5 hover:bg-[#007BFF]/10 flex items-center gap-2"
              >
                <Send size={16} />
            ...
            <div className="mb-6">
              <h3 className="font-medium text-[#343A40] mb-2">
                {job.related_job}
              </h3>
            </div>

            <div className="mb-6 pb-4 border-b">
              <h3 className="font-medium text-[#343A40] mb-3">
                Mô tả công việc
              </h3>
        ...
        <div className="md:col-span-1">
          ...
          <div className="bg-white rounded border p-6 mb-6">
            <h2 className="text-lg font-bold text-[#343A40] mb-4">
              Thông tin chung
            </h2>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Thứ 2 đến hết sáng Thứ 7 (8h00 - 17h15)
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded border p-6">
            ...
            <div className="flex flex-wrap gap-2">
              <Button
                variant="outline"
                size="sm"
                className="text-[#1877F2] border-[#1877F2]/20 bg-[#1877F2]/5 hover:bg-[#1877F2]/10"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
              ...
              <Button
                variant="outline"
                size="sm"
                className="text-[#1DA1F2] border-[#1DA1F2]/20 bg-[#1DA1F2]/5 hover:bg-[#1DA1F2]/10"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
              ...
              <Button
                variant="outline"
                size="sm"
                className="text-[#0A66C2] border-[#0A66C2]/20 bg-[#0A66C2]/5 hover:bg-[#0A66C2]/10"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
              ...
              <Button
                variant="outline"
                size="sm"
                className="text-[#25D366] border-[#25D366]/20 bg-[#25D366]/5 hover:bg-[#25D366]/10"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
              ...
              <Button
                variant="outline"
                size="sm"
                className="text-[#007BFF] border-[#007BFF]/20 bg-[#007BFF]/5 hover:bg-[#007BFF]/10"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
